...
const SiberianHuskyPage: React.FC = () => {
  return (
    <section className="bg-white">
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Available Siberian Husky Puppies</h2>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {[...Array(6)].map((_, index) => (
            <div key={index} className="border border-gray-300 rounded-lg p-4">
              <img src="/siberian-husky-puppy.jpg" alt={`Puppy ${index + 1}`} className="w-full h-auto rounded-lg mb-2" />
