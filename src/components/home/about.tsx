    ...
    <section className="py-16  flex flex-col md:flex-row items-center scroll-mt-24" id="about">
      ...
      <div className="w-full md:w-1/2 text-left px-8">
        ...
        <p className="text-md mb-4">
          At AngelPom Kennel, our mission is to connect loving families with their ideal puppy companions. We understand that choosing a pet is a significant decision, and we're here to guide you every step of the way.
        </p>
        <p className="text-md mb-4">
